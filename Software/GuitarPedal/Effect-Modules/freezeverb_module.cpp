...
// [STEP] Include RNBO's export under its NATIVE filename (RNBO writes
// "<classname>.cpp.h"). Previously this was renamed to "freezeverb_cpp.h" by
// hand on every export; including the native name means you just drop the
// export into dependencies/RNBO/ as-is. The file in dependencies/RNBO/ must
// therefore be named "freezeverb.cpp.h".
